...
<div class="uk-alert" markdown="1">In the control panel or the tool menu you have an options icon that when clicked will open a new window containing the various extension options.</div>
...
<div class="uk-alert" markdown="1">Note: cURL is necessary for the system to function correctly.</div>
...
<div class="uk-alert" markdown="1">For more info on how to get an API key scroll down to How do I get an API Key?</div>
...
<div class="uk-alert" markdown="1">I recommend at least turning it for the Social Links module as there aren't any visible counts.</div>
...
<div class="uk-alert" markdown="1">Some of the options selected here will affect the display of the buttons in Joomla, K2 and Zoo.</div>

<div class="uk-alert" markdown="1">To make it easier to follow I have broken up the **Like Plugin Options** into three parts.</div>
...
<div class="uk-alert" markdown="1">To make it easier to follow I have broken up the **Share Plugin Options** into three parts.</div>
...
<div class="uk-alert" markdown="1">To make it easier to follow I have broken up the **Social Panel Plugin Options** into five parts.</div>
...
<div class="uk-alert" markdown="1">The Fixed Style will automatically convert to Collapse when the page reaches a certain size.</div>
...
<div class="uk-alert" markdown="1">To make it easier to follow I have broken up the **Metadata Options** into four parts.</div>
...
<div class="uk-alert" markdown="1">Note: FB will only use images that are at least 200x200 px. FB prefers images that are measured in multiples of 100 and square format.</div>

<div class="uk-alert" markdown="1">Note: Twitter will only use images that are at least 280x150 px.</div>
...
<div class="uk-alert" markdown="1">To make it easier to follow I have broken up the **General Display Options** into three parts.</div>

#### Part 1

In this section you can choose the icon style, size and alignment, title alignment as well as the title format. *\[Figure-9\]*

<div class="uk-alert" markdown="1">Want to create a custom theme? Have a look at [Creating a Custom Theme](#mod-custom-theme)</div>
...
<div class="uk-alert" markdown="1">To make it easier to follow I have broken up the **Share This General** into two parts.</div>
...
<div class="uk-alert" markdown="1">To make it easier to follow I have broken up the **Share This Social Options** into two parts.</div>
...
<div class="uk-alert" markdown="1">When adding links use the domain without the http:// for example **www.facebook.com** or for **Mail Us** email@social.com </div>
...
<div class="uk-alert" markdown="1">When adding links use the domain without the http:// for example **www.facebook.com**.</div>
...
<div class="uk-alert" markdown="1">Note: If Social Tabs using jQuery is loaded on a device with a screen size smaller than **1024** the slide out effect is disabled.</div>
...
<div class="uk-alert" markdown="1">To make it easier to follow I have broken up the **Share Options** into two parts.</div>
...
<div class="uk-alert" markdown="1">Note: jQuery is loaded by default on Joomla 3.x but if you don't have it loaded on your system and you would like to use the jQuery option turn it on in the included **System - CW Gears plugin**.</div>
...
<div class="uk-alert" markdown="1">Valid Ranges: Portrait 180-450 px Landscape 273-450px </div>
...
<div class="uk-alert" markdown="1">If you need more than one type of badge just create another module.</div>
...
<div class="uk-alert" markdown="1">To make it easier to follow I have broken up the **Layout & Style Options** into two parts.</div>
...
<div class="uk-alert" markdown="1">Social Panel needs jQuery to function correctly. If you don't already have it loaded use the System - CW Gears plugin.</div>
...
<div class="uk-alert" markdown="1">To make it easier to follow I have broken up **Social Metadata** into two parts.</div>
